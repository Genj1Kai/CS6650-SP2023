...
public class RequestProcessor implements Runnable{
  ...
  public static final Integer SWIPEE_END = 500;
  ...
  public void run() {
    ...
    apiInstance.getApiClient().setBasePath(Client.BASE_URL);
...
//          throw new RuntimeException(e);
      ...
      Record record = new Record(startTime, "Post", latency, responseCode);
